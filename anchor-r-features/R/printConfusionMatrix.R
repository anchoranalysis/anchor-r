...
printConfusionMatrix <- function( groundTruthLabel, predictedLabel ) {
  #
  #  Prints a confusion matrix for label predictions against ground-truth
  #
  #  Note that the library function confusionMatrix
  #
  #  Args:
